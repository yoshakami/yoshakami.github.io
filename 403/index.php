...
<p> index.html doesn't exists in this directory, that's a bummer.</p>
...
<script type="text/javascript">
    ...
    if (window.location.href === "https://yoshi-web-store.com/403/" || timestamp.toString() !== window.location.href.split("?")[1])
    {
        scroll(0,0)
        window.history.replaceState(null, document.title, '/403/?' + timestamp.toString());
    }
